...
function spawnEnemies(){
    setInterval(()=>{
        const radius = Math.random()* (30 - 5) + 5 //30 as the maximum size of enemy and 5 as minimum
        let x
        let y
...
function animate(){
    ...
    projectiles.forEach((projectile,index)=>{
        ...
        //left|| right || top || bottom side of the screen
        if(
...
addEventListener('click',(event)=>{
    ...
    const velocity = {
        //velocity is 5 times faster than default
